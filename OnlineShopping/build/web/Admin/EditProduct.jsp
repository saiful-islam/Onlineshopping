...
<html>
    ...
    <%
        ...
        session.setAttribute("actionName", "editproduct");
    %>
    <body>
        <div>
        ...
        <div>
            <form action="/OnlineShopping/AdminServlet" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <input type="text" style="display: none;" class="form-control" id="inputProdId" name ="inputProductId">
        ...
        <script type="text/javascript">
            ...
            var prodName = getParameterByName('name');
            var prodPrice = getParameterByName('price');
            document.getElementById("inputProdId").value = prodId;
            document.getElementById("inputProd").value = prodName;
            document.getElementById("inputPri").value = prodPrice;
        </script>
</html>
